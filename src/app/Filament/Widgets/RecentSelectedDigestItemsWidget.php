...
/**
 * 最近 selected になった Digest Item を表示する table widget
 */
class RecentSelectedDigestItemsWidget extends TableWidget
{
    protected static ?string $heading = 'Recent selected items';
    ...
    {
        return $table
            ->query($this->recentQuery('selected'))
