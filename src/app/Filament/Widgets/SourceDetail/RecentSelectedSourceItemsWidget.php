...
/**
 * Source-specific recent selected items を表示する widget
 */
class RecentSelectedSourceItemsWidget extends Widget
{
    ...
    protected function getViewData(): array
    {
        return [
            ...
            'rows' => $this->sourceReport()['recent']['selected'],
            'emptyMessage' => 'No recent selected items.',
        ];
    }
}
